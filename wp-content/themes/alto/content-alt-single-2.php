<?php
/**
 * This is the second alternative single post template. Users can
...
<article id="post-<?php the_ID(); ?>" <?php post_class('alt-post alt-post-2'); ?>>
  ...
  <?php if ( $thumbnail ) { ?>
    ...
    <div class="full-width-image-header">
      <?php the_post_thumbnail( 'alt-single-post-2' ); ?>
    </div> <!-- end .full-width-image-header -->
