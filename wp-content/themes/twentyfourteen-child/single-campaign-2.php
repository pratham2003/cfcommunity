...
get_header(); ?>
	...
	<div id="content" class="post-details">
		...
		<div class="call-out">
			<h2>Help ons bij het opzetten van een online community voor mensen met Cystic Fibrosis (en hun familie en vrienden). Bekijk de video,lees de campagne en <a class="contribute" href="http://support.cfcommunity.net/campaigns/cfcommunity-net/#contribute-now">steun ons!</a></h2>
		</div>
				...
				<div class="image">
					<?php if ( $campaign->video() ) : ?>
						<div class="video-container">
							<div class="youtube" id="8LFmsnzoTIM" style="width: 740px; height: 400px;"></div>
				...
				<div class="right-side">
					<ul class="campaign-stats">
						...
						<li class="backer-count">
							...
							<p><?php echo _n( 'Donateur', 'Donateurs', $campaign->backers_count(), 'number of backers', 'fundify' ); ?></p>
						</li>
					...
					<div class="contribute-now">
						...
						<?php endif; ?>
						<br>
						<div class="safe"><strong>Alle donaties worden afgehandeld via een beveiligde IDeal omgeving.</strong></div>
			...
			<aside id="sidebar">
				...
				<iframe src="//www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2Fpages%2FCFCommunitynet-Where-people-with-Cystic-Fibrosis-meet%2F176854133478&amp;width=300&amp;height=290&amp;show_faces=true&amp;colorscheme=light&amp;stream=false&amp;show_border=false&amp;header=true&amp;appId=373304758070" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:300px; height:290px;" allowTransparency="true"></iframe>
			</aside>
