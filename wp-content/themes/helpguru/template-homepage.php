...
<?php if (get_theme_mod( 'ht_hp_headline' )) : ?><h2 id="page-header-title"><?php echo get_theme_mod( 'ht_hp_headline' ); ?></h2><?php endif; ?>
<?php if (get_theme_mod( 'ht_hp_tagline' )) : ?><h3 id="page-header-tagline"><?php echo get_theme_mod( 'ht_hp_tagline' ); ?></h3><?php endif; ?>
