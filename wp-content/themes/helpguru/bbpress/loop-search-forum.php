...
<div class="bbp-forum-header">
	...
	<span class="bbp-reply-post-date"><a href="<?php bbp_forum_permalink(); ?>" class="bbp-reply-permalink"><i class="fa fa-link"></i></a><?php printf( __( 'Last updated %s', 'bbpress' ), bbp_get_forum_last_active_time() ); ?></span>
