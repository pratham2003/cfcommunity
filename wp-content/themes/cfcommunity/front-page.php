      ...
      <div class="row">
       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h2 class="section-title page-top">
          <span>A community for people affected by Cystic Fibrosis</span>
        </h2>
      </div>
  ...
  <div class="container">
    <div class="content row row-offcanvas row-offcanvas-left">
      <div class="main col-xs-12 col-sm-12" role="main">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2 class="section-title grey"><i class="fa fa-reply"></i> What role does Cystic Fibrosis play in your life?</h2>
          </div>
        </div>
          ...
          <div class="left-tabs">
            <div class="col-xs-4 col-sm-4 col-md-3 col-lg-3">
              <ul id="myTab" class="nav nav-tabs">
                <li class="active"><a href="#noimage" data-toggle="tab"><i class="fa fa-chevron-circle-right"></i> I have CF</a></li>
                <li class=""><a href="#leftimage" data-toggle="tab"><i class="fa fa-chevron-circle-right"></i> My family member/partner has CF</a></li>
                <li class=""><a href="#1-2-col" data-toggle="tab"><i class="fa fa-chevron-circle-right"></i> I work with CF</a></li>
                <li class=""><a href="#rightimage" data-toggle="tab"><i class="fa fa-chevron-circle-right"></i> I have a CF related cause</a></li>
              </ul>
            </div>
            <div class="col-xs-8 col-sm-8 col-md-9 col-lg-9">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                         <h3>Breaking news: Life with CF is different!</h3>
                       </div>

                       <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">


                        <p><strong>Just kidding, you already knew that.</strong> There's always a bunch of stuff going on that only others with CF truly understand. With CFCommunity we've created a place where we can hang out and talk about all the things that make life with CF different/awesome/lame/special. 
                        </p>
                      ...
                      <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 side-column">
                        ...
                        <a href="http://cfcommunity.net/register" class="btn-block btn btn-success" type="button">
                          <i class="fa fa-user"></i> Sign up for CFCommunity
                        </a>
              ...
              <div class="tab-pane fade" id="leftimage">
                <div class="panel panel-default">
                  ...
                  <h3 class="big-title">A meeting place for everyone affected by Cystic Fibrosis </h3>

                       </div>

                       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">

                        <p><strong>A baby sister. an older brother. a wife. a girlfriend. All the people in the pictures above deal with CF every day. </strong></p>

                        <p>CFCommunity is not just for people who have CF. We've also made it for you; someone who loves someone with CF. A (grand)child, a sibling or your partner, we want to make it easy for you to connect with others in the same situation.</p>

                        <p>Every person who becomes a member of our community fills in their relationship with CF. We use this information (along with your location and age) to let you easily search for and connect with people on CFCommunity! </p>

                        <p>By using our Discussion Groups you can talk about specific subjects in-depth and in private. Finally if you need further support or want to stay up to date about all the medical news, our Causes page let's you easily find and connect with all the CF related initiatives out there! </p>

                        <p>We hope to see you on CFCommunity soon!<br><br>

                        Bowe, Sarah & the rest of the CFCommunity Team</p>
              ...
              <div class="tab-pane fade" id="1-2-col">
                <div class="panel panel-default">
                  <div class="panel-body">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                         <h3>Bringing all the Cystic Fibrosis related causes from across the world under one roof</h3>
                    </div>

                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">


                        <p><strong>By creating a page for your cause on CFCommunity you can share news, post updates, brochures and connect with the people in our community.</strong> If you currently manage a Facebook Page for your cause you get the idea (with the big difference that we actually care about your cause and you reaching your audience without having to pay! ;-) </p> 

                        <p><strong>With CFCommunity we are not trying to get in the way of any of the existing CF related causes.</strong> It's our goal to make it as easy as possible for our community members to find and follow the causes that are important to them. If you would like to directly engage with our community you can choose to open a discussion forum but this is completely optional. </p> 

                        <p>You can learn more about starting a Cause Page on CFCommunity by clicking here!</p> 
