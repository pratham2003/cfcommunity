...
function cfc_scripts() {
  wp_enqueue_style('cfc_main', get_template_directory_uri() . '/assets/css/main.min.css', false, '483a77c0a2f2029c4bb29bef1fe3962b');
  ...
  wp_register_script('cfc_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array(), 'e4584ac0e1ebcc61d4f3909c2b590fd2', true);
