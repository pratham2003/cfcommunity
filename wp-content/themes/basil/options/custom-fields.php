...
function basil_register_page_meta_boxes() {
	...
	Carbon_Container::factory('custom_fields', __('Boxy Page Builder','basil'))
		->show_on_post_type('page')
		->add_fields(array(
		
			# Slider Sections
			Carbon_Field::factory('separator', 'basil_page_sections_title', __('Page Sections', 'basil')),
			Carbon_Field::factory('complex', 'basil_page_sections', '')
				->setup_labels(array(
					'singular_name' => __('Page Section', 'basil'),
					'plural_name'   => __('Page Sections', 'basil'),
				))
				->add_fields('recipe_slider', array(
				...
				->add_fields('featured_recipes', array(
				...
				->add_fields('featured_products', array(
				...
				->add_fields('page_content', array(
					...
					# Sidebar Select
					Carbon_Field::factory('choose_sidebar', 'page_sidebar', __('Choose Sidebar for Page', 'basil'))
						->set_sidebar_options(crb_get_default_sidebar_options())->disable_add_new(),
				...
				->add_fields('widget_columns', array(
					...
					Carbon_Field::factory('complex', 'widget_block_columns', __('Widget Columns', 'basil'))
						...
						->add_fields('widget_column', array(
							# Recipe
							Carbon_Field::factory('choose_sidebar', 'sidebar', __('Choose Sidebar', 'basil'))
								->set_sidebar_options(crb_get_default_sidebar_options())->disable_add_new(),
				...
				->add_fields('recent_tweets', array(
