...
class BoxyWidgetRecentTweets extends BoxyWidgetBase {
	...
	*/
	function BoxyWidgetRecentTweets() {
		...
		$this->WP_Widget('theme-widget-recent-tweets', __('BASIL &mdash; Twitter Feed','basil'), $widget_opts, $control_ops);
...
class BoxyWidgetFacebookFeed extends BoxyWidgetBase {
	...
	*/
	function BoxyWidgetFacebookFeed() {
		...
		// widget id, widget display title, widget options
		$this->WP_Widget('theme-widget-facebook-feed', __('BASIL &mdash; Facebook Feed','basil'), $widget_opts, $control_ops);
		$this->custom_fields = array(
			array(
				'name'=>'title',
				'type'=>'text',
