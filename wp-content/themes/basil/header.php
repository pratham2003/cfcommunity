		...
		<header id="basilHeader"<?php if ($header_class): ?> class="<?php echo $header_class; ?>"<?php endif; ?>>
			...
			<section id="basilHeaderTop">
				<div class="basilShell clearfix">
					<div class="basilLeft" style="height:<?php echo $logo_height; ?>px; position:relative; top:50%; margin-top:-<?php echo round($logo_height/2); ?>px;">
						<a href="<?php echo home_url(); ?>" id="basilLogo"><img src="<?php echo $logo_url; ?>" alt="<?php bloginfo('name'); ?>" /></a>
					</div>
					<div class="basilRight" style="height:35px; position:relative; top:50%; margin-top:-18px;"><?php
						...
						switch($top_right_content){
							...
							case 'text' :
								echo wpautop(ot_get_option('to_header_top_right_text'));
							break;
