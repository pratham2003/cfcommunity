		...
		<div class="row">
			<div class="col-sm-8">
				...
				<div class="video-details"> 
                    <span class="date"><?php printf('Published on %s by %s', get_the_date('M d, Y'), $author );?>	<a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php $author = the_author_meta('user_login'); ?></a></span>
