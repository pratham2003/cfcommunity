...
function buddyboss_customizer_live_preview() {
    ...
    wp_enqueue_script( 'buddyboss-theme-customizer', get_template_directory_uri() . '/buddyboss-inc/buddyboss-customizer/js/buddyboss-customizer.js', array( 'jquery', 'customize-preview' ), '3.1.1.0', true );
...
function buddyboss_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'buddyboss_logo_section' , array(
	    ...
	    'priority'    => 30,
	    'description' => 'Upload logo in place of site title and tagline.',
	) );
	...
	$wp_customize->add_section( 'buddyboss_adminbar_section' , array(
	    ...
	    'priority'    => 40,
	    'description' => __( 'Dock a full-width Toolbar to the top of the page, or float it to the right.' ),
	) );
	...
	$wp_customize->add_section( 'boss_colors_layout_section' , array(
	    ...
	    'priority'    => 50,
	    'description' => __( 'Select your color scheme. To preview in mobile, just collapse the width of this browser window.' ),
	) );
	...
	$wp_customize->add_section( 'boss_colors_text_section' , array(
	    ...
	    'priority'    => 60,
	    'description' => __( 'Text color options. To preview in mobile, just collapse the width of this browser window.' ),
	) );
	...
	$wp_customize->add_section( 'buddyboss_body_font_section' , array(
	    ...
	    'priority'    => 70,
	    'description' => __( 'Select your desired fonts.' ),
	) );
	...
	$wp_customize->add_section( 'buddyboss_social_section' , array(
	    ...
	    'priority'    => 80,
	    'description' => __( 'Social media links will display in the footer after you click Save &amp; Publish.' ),
	) );
