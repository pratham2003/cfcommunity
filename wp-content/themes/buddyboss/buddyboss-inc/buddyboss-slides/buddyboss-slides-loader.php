...
function buddyboss_save_events_meta($post_id, $post) {
...
add_action('save_post', 'buddyboss_save_events_meta', 1, 2); // save the custom fields
 ...
 *
 */
// Adds styles for the image slider.
if ( !is_admin() ) // no loading in the dashboard
    wp_enqueue_style( 'buddyboss-slides-main', get_template_directory_uri() . '/buddyboss-inc/buddyboss-slides/css/buddyboss-slides.css', false, '3.1.2', 'all' );
