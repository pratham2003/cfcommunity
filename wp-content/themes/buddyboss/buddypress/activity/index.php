      ...
      <ul>
          ...
          <?php if ( is_user_logged_in() ) : ?>
              ...
              <?php if ( bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ) : ?>
                ...
                <li id="activity-favorites"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/favorites/'; ?>" title="<?php _e( "The activity I've marked as a favorite.", 'buddyboss' ); ?>"><?php printf( __( $fav_tab_text.' <span>%s</span>' ), bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ); ?></a></li>
