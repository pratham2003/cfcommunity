...
<?php
$queryObject = new WP_Query( 'post_type=buddyboss_slides&posts_per_page=-1' );
				...
				<div class="slide"> 
				    ...
				    <div class="slide_content">
				        <div class="slide_content_wrap">
					        ...
					        <?php
					        if (!empty($learnmore_url) && !empty($learnmore_text)) {
					        echo '<p class="readmore"><a href="'.esc_url($learnmore_url).'" target="_blank" />'.esc_html($learnmore_text).'</a></p>';
					        }
					        ?>
