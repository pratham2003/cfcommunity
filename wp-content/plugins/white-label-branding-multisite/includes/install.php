...
function handle_wlb_install($option_varname='MWLB'){
	//---
	...
	$install_bundles = array(
		WLB_PATH.'bundles/blue_sky_and_grass.php',
		WLB_PATH.'bundles/old_mathematics.php',
		WLB_PATH.'bundles/tiles_and_grass.php'
	);
	if(!class_exists('pop_importer'))require_once WLB_PATH.'options-panel/class.pop_importer.php';
