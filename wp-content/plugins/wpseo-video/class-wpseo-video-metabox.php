...
if ( ! class_exists( 'WPSEO_Video_Metabox' ) ) {
	...
	class WPSEO_Video_Metabox extends WPSEO_Metabox {
		...
		function snippet_preview( $content, $post, $vars ) {
			...
			$content = '<div id="wpseosnippet">
				<table class="video" cellpadding="0" cellspacing="0">
					<tr>
						<td colspan="2">
							<h4 style="margin: 0; font-weight: normal;"><a class="title" target="_blank" href="' . esc_url( get_permalink( $post->ID ) ) . '">' . $vars['title'] . '</a></h4>
						</td>
					</tr>
					<tr>
		 ...
		 * @since 0.1
		 *
		 * @todo should 115 be an override of the WPSEO_Meta property ? or a property of this class ?
		 *
