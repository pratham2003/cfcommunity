...
class BuddyBoss_Wall_Admin
{
	...
	public function admin_init()
	{
		...
		add_settings_section( 'general_section', 'General Settings', array( $this, 'section_general' ), __FILE__ );
		// add_settings_section( 'style_section', 'Style Settings', array( $this, 'section_style' ), __FILE__ );

		//general options
		add_settings_field( 'enabled', 'Enable Wall Component', array( $this, 'setting_enabled' ), __FILE__, 'general_section' );
		add_settings_field( 'all-members', 'Available to all members', array( $this, 'setting_available_to_allmembers' ), __FILE__, 'general_section' );
