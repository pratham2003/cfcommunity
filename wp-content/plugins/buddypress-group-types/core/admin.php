...
function bpgt_admin_save() {
	...
	switch ( $_POST['mode'] ) {
		case 'add':
			...
			$type->disabled_plugins = apply_filters( 'bpgt_admin_create_type_disabled_plugins', (array) $_POST['type_disabled_plugins'] );
			$type->disabled_plugins = apply_filters( 'bpgt_admin_update_type_disabled_plugins', explode( ',', trim( $_POST['type_disabled_plugins'], ' ,' ) ) );
