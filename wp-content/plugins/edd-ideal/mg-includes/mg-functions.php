...
if ( ! function_exists( 'is_woocommerce_activated' ) ) {
	function is_woocommerce_activated() { return MG_Dependencies::woocommerce_active_check(); }
}
...
if ( ! function_exists( 'is_jigoshop_activated' ) ) {
	function is_jigoshop_activated() { return MG_Dependencies::jigoshop_active_check(); }
}
...
if ( ! function_exists( 'is_edd_activated' ) ) {
	function is_edd_activated() { return MG_Dependencies::edd_active_check(); }
}
