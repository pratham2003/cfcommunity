...
$rtmedia_backbone = array(
	'backbone' => false, 'is_favlist' => false, 'is_edit_allowed' => false
);
if ( isset( $_POST[ 'backbone' ] ) ){
	$rtmedia_backbone[ 'backbone' ] = $_POST[ 'backbone' ];
}
if ( isset( $_POST[ 'is_favlist' ] ) ){
	$rtmedia_backbone[ 'is_favlist' ] = $_POST[ 'is_favlist' ][ 0 ];
}
if ( isset( $_POST[ 'is_edit_allowed' ] ) ){
	$rtmedia_backbone[ 'is_edit_allowed' ] = $_POST[ 'is_edit_allowed' ][ 0 ];
}
?>
<li class="rtmedia-list-item favlist" id="<?php echo rtmedia_id(); ?>">
